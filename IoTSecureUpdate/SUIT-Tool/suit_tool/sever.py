...
def main(options):
    ...
    tagged_envelope = cbor.loads(options.manifest.read())
    envelope = tagged_envelope.value
    ...
    tagged_envelope.value = envelope
    output = cbor.dumps(tagged_envelope, canonical=True)
